...
| 属性 | 值 |
|------|-----|
| **文档版本** | v1.0 (2025硬件架构完整对标版) |
| **创建日期** | 2025-10-22 |
| **理论基础** | 硬件虚拟化、芯片组架构、IO虚拟化 |
| **实证数据** | Intel SDM、PCIe 6.0规范、CXL 3.0规范 |
| **对标来源** | Intel/AMD 2025规范、PCI-SIG、JEDEC |
| **状态** | 硬件架构完整形式化论证 |

> **核心论断**: 2025年硬件架构已从"北桥-南桥"二元结构演进为"CPU片上集成+PCH+CXL"三元架构，虚拟化/容器化/沙盒化的硬件边界由CPU特权级、IOMMU地址空间、PCIe配置空间三个正交维度共同定义。
