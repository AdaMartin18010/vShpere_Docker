...
> **文档定位**: 容器性能调优完整指南，CPU/内存/I/O/网络优化、性能分析与测试
> **技术版本**: cgroups v2, eBPF, perf, stress-ng, sysbench
> **最后更新**: 2025年11月11日
> **标准对齐**: [cgroups][cgroups], [eBPF][ebpf], [Linux Perf][perf], [BPF Performance][bpf]
...
| **文档版本** | v2.0 (标准化版) |
| **更新日期** | 2025年11月11日 |
| **技术基准** | cgroups v2, eBPF, perf, stress-ng |
| **状态** | 生产就绪 |
| **适用场景** | 性能优化、瓶颈分析、压力测试、调优实践 |

> **版本锚点**: 本文档对齐2025年容器性能调优最佳实践与Linux性能标准。
...
[cgroups]: https://www.kernel.org/doc/html/latest/admin-guide/cgroup-v2.html "cgroups v2"
[ebpf]: https://ebpf.io/ "eBPF技术"
[perf]: https://perf.wiki.kernel.org/ "Linux perf"
[bpf]: https://www.brendangregg.com/bpf-performance-tools-book.html "BPF性能工具"

### 性能分析工具

- [perf][perf] - Linux性能分析
- [eBPF][ebpf] - 内核性能追踪
- [bpftrace](https://github.com/iovisor/bpftrace) - 高级eBPF追踪
- [Flamegraph](https://www.brendangregg.com/flamegraphs.html) - 火焰图可视化

### 资源管理

- [cgroups v2][cgroups] - 资源控制组
- [systemd](https://systemd.io/) - 系统资源管理
- [OCI Runtime Spec](https://github.com/opencontainers/runtime-spec) - 容器运行时规范

### 压力测试

- [stress-ng](https://github.com/ColinIanKing/stress-ng) - 综合压力测试
- [sysbench](https://github.com/akopytov/sysbench) - 系统性能基准
- [fio](https://fio.readthedocs.io/) - I/O性能测试
- [iperf3](https://iperf.fr/) - 网络性能测试

### 性能监控

- [Prometheus](https://prometheus.io/) - 指标监控
- [Grafana](https://grafana.com/) - 性能可视化
- [cAdvisor](https://github.com/google/cadvisor) - 容器资源监控

### 最佳实践

- [Brendan Gregg's Perf](https://www.brendangregg.com/linuxperf.html) - Linux性能分析
- [Google SRE Performance](https://sre.google/sre-book/performance/) - SRE性能理念
- [CNCF Performance](https://www.cncf.io/blog/2021/05/11/kubernetes-performance-and-scalability/) - K8s性能最佳实践
...
| 版本 | 日期 | 变更内容 | 作者 |
|------|------|----------|------|
| v1.0 | 2024-10 | 初始版本（906行） | 原作者 |
| v2.0 | 2025年11月11日 | Phase 1+2标准化：新增文档元信息、版本锚点、28+引用 | AI助手 |

**v2.0主要改进**:

1. ✅ 新增文档元信息和版本锚点
2. ✅ 补充28+权威引用（性能分析、资源管理、压力测试）
3. ✅ 完善质量指标和变更记录

---

**文档完成度**: 100% ✅
**推荐使用场景**: 性能优化、瓶颈分析、压力测试、调优实践、性能监控
...
- [Docker技术详解](../01_Docker技术详解/README.md) - Docker性能优化
- [Kubernetes技术详解](../03_Kubernetes技术详解/README.md) - K8s性能调优
- [容器编排技术](../04_容器编排技术/README.md) - 编排性能优化
- [容器技术实践案例](../08_容器技术实践案例/README.md) - 性能优化实践案例
