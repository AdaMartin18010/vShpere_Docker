...
> **文档定位**: 容器日志管理完整指南，ELK/EFK、Loki、Fluentd、日志分析与可视化
> **技术版本**: ELK 8.0+, Loki 2.9+, Fluentd 1.16+, Fluent Bit 2.0+
> **最后更新**: 2025年11月11日
> **标准对齐**: [ELK Stack][elk], [Loki][loki], [Fluentd][fluentd], [CNCF Logging][cncf]
...
| **文档版本** | v2.0 (标准化版) |
| **更新日期** | 2025年11月11日 |
| **技术基准** | ELK, Loki, Fluentd, Fluent Bit |
| **状态** | 生产就绪 |
| **适用场景** | 日志收集、日志分析、日志可视化、故障排查 |

> **版本锚点**: 本文档对齐2025年容器日志管理最佳实践与CNCF标准。
...
[elk]: https://www.elastic.co/elastic-stack "ELK Stack"
[loki]: https://grafana.com/oss/loki/ "Grafana Loki"
[fluentd]: https://www.fluentd.org/ "Fluentd日志收集"
[cncf]: https://www.cncf.io/projects/ "CNCF项目"

### 日志收集

- [Fluentd][fluentd] - CNCF统一日志收集
- [Fluent Bit](https://fluentbit.io/) - 轻量级日志处理
- [Filebeat](https://www.elastic.co/beats/filebeat) - Elastic日志采集
- [Logstash](https://www.elastic.co/logstash) - 日志处理管道

### 日志存储

- [Elasticsearch](https://www.elastic.co/elasticsearch/) - 分布式搜索引擎
- [Loki][loki] - Grafana日志聚合
- [ClickHouse](https://clickhouse.com/) - 列式数据库
- [S3](https://aws.amazon.com/s3/) - 对象存储

### 日志可视化

- [Kibana](https://www.elastic.co/kibana) - ELK可视化
- [Grafana](https://grafana.com/) - 统一可视化平台
- [OpenSearch Dashboards](https://opensearch.org/docs/latest/dashboards/) - OpenSearch可视化

### 日志分析

- [ELK Stack][elk] - Elasticsearch+Logstash+Kibana
- [EFK Stack](https://www.fluentd.org/guides/recipes/elasticsearch-and-s3) - Elasticsearch+Fluentd+Kibana
- [PLG Stack](https://grafana.com/blog/2020/10/28/loki-2.0-released-transform-logs-as-youre-querying-them-and-set-up-alerts-within-loki/) - Prometheus+Loki+Grafana

### 日志平台

- [Splunk](https://www.splunk.com/) - 企业级日志平台
- [Datadog Logs](https://www.datadoghq.com/product/log-management/) - 云原生日志
- [New Relic Logs](https://newrelic.com/products/log-management) - APM日志

### 最佳实践

- [12-Factor App Logs](https://12factor.net/logs) - 日志最佳实践
- [CNCF Observability](https://www.cncf.io/blog/2021/08/06/what-is-observability/) - 可观测性标准
- [Google SRE Logs](https://sre.google/sre-book/monitoring-distributed-systems/) - SRE日志理念
...
| 版本 | 日期 | 变更内容 | 作者 |
|------|------|----------|------|
| v1.0 | 2024-10 | 初始版本（1071行） | 原作者 |
| v2.0 | 2025年11月11日 | Phase 1+2标准化：新增文档元信息、版本锚点、30+引用 | AI助手 |

**v2.0主要改进**:

1. ✅ 新增文档元信息和版本锚点
2. ✅ 补充30+权威引用（日志收集、存储、分析、可视化）
3. ✅ 完善质量指标和变更记录
...
- [容器监控技术](./01_容器监控技术.md) - 容器监控技术
- [容器性能调优](./03_容器性能调优.md) - 容器性能优化
- [容器故障诊断](./04_容器故障诊断.md) - 容器故障排查
- [容器自动化运维](./05_容器自动化运维.md) - 容器自动化运维
- [README.md](./README.md) - 本模块导航

### 其他模块相关

- [Kubernetes监控与日志管理](../03_Kubernetes技术详解/06_监控与日志管理.md) - Kubernetes日志管理
- [容器安全技术](../05_容器安全技术/README.md) - 安全日志审计
- [容器编排技术](../04_容器编排技术/README.md) - 编排平台日志
- [容器技术实践案例](../08_容器技术实践案例/README.md) - 日志管理实践

---

**文档完成度**: 100% ✅
**推荐使用场景**: 日志收集、日志分析、日志可视化、故障排查、合规审计
